const projects = [ 
  ...
  },
  {
    ...
    content: 
      "Designed face detection and tracking application’s workflow and infrastructure in an agile way for quick and efficient deployment. Created a pipeline to capture and preprocess the face images, extract the facial features, perform similarity checks and track the faces using image processing and OpenCV algorithms. Deployed and tested in real-time using stream lit.",
    dark: false
  },
  {
    ...
    content: 
      "Developed an Android application to curb food wastage by redirecting the wasted food from the restaurants to needy people. Published the application in real-time and integrated it with the Google Maps API and tested with Payments API." ,
    dark: false
  },
  {
    ...
    content: 
      "Designed and implemented working prototype with multiple algorithms for indoor positioning system using BLE Beacons. Worked on reducing the algorithm precision error by 5% and increased accuracy by 9%. Deployed the algorithm in an android application and tested it in real-time." ,
    dark: false
  },
    {
  ...
  },
  {
    ...
    content:
      "Online Leave Management System is a web-based application that is developed using PHP and MySQL. The main objective of this Leave Management System is to manage the details of Leave, Employee details ,Attendance. It manages all the information about Leave, Leave Type, Attendance, Leave.",
    dark: false
  },
  {
